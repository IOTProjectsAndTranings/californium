...
import static org.eclipse.californium.examples.PreferenceIDs.PREF_DTLS_CREDENTIALS;
import static org.eclipse.californium.examples.PreferenceIDs.PREF_DTLS_SESSION;
...
public class CoapActivity extends AppCompatActivity {
    ...
    private String dtlsCredentialsModeName;
    private String dtlsSessionModeName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dtlsCredentialsModeName = preferences.getString(PREF_DTLS_CREDENTIALS, SetupCalifornium.DtlsCredentialsMode.X509.name());
        dtlsSessionModeName = preferences.getString(PREF_DTLS_SESSION, SetupCalifornium.DtlsSessionMode.CID.name());
    ...
    private void adjustDtlsMode() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String dtlsCredentialsModeName = preferences.getString(PREF_DTLS_CREDENTIALS, SetupCalifornium.DtlsCredentialsMode.X509.name());
        String dtlsSessionModeName = preferences.getString(PREF_DTLS_SESSION, SetupCalifornium.DtlsSessionMode.CID.name());
        if (!dtlsCredentialsModeName.equals(this.dtlsCredentialsModeName) || !dtlsSessionModeName.equals(this.dtlsSessionModeName)) {
            this.dtlsCredentialsModeName = dtlsCredentialsModeName;
            this.dtlsSessionModeName = dtlsSessionModeName;
            CoapContext.getInstance().resetSessionCache();
