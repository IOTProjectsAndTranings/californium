...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void update(SharedPreferences preferences) {
        ...
        updateSummary(preferences, PREF_DTLS_CREDENTIALS);
        updateSummary(preferences, PREF_DTLS_SESSION);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (PREF_DESTINATION_HOST.equals(key) ||
                ...
                PREF_DTLS_CREDENTIALS.equals(key) ||
                PREF_DTLS_SESSION.equals(key) ||
